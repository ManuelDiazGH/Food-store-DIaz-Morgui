  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        <h2 className="text-lg font-semibold text-stone-900 mb-2">Gestionar Stock</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-sm font-medium text-stone-700 mb-2">Modo</label>
            <div className="flex gap-4">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-blue-600 border-stone-300 focus:ring-brand-500"
                />
                <span className="text-sm text-stone-700">Incremento</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="radio"
                  ...
                  className="w-4 h-4 text-blue-600 border-stone-300 focus:ring-brand-500"
                />
                <span className="text-sm text-stone-700">Absoluto</span>
              </label>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-stone-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
